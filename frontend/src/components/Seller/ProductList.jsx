      ...
      >
        <div
          ...
          style={{
            ...
            boxShadow: "0 24px 64px #1E100840",
            fontFamily: "'DM Sans', sans-serif",
          }}
        ...
        >
          {/* Header */}
          <div
            className="relative px-6 pt-6 pb-5 rounded-t-[28px] sm:rounded-t-[24px] overflow-hidden"
            style={{
              background:
                "linear-gradient(135deg,#5C2A14 0%,#8B3A2A 60%,#A84A34 100%)",
            }}
          >
            <div
            ...
            <div className="relative flex items-center justify-between gap-4">
              <div>
                <p
                  ...
                  style={{ color: "#FAF0DC99" }}
                >
                  Editing product
                </p>
                <h2
                  className="text-xl font-bold leading-tight"
                  style={{ fontFamily: "'Lora', serif", color: "#FAF0DC" }}
                >
                  {product.name}
                </h2>
              </div>
          ...
          <div className="px-6 py-5 flex flex-col gap-4">
            ...
            <div
              ...
              style={{ background: "#F5EDD8", border: "1px solid #E8D8B8" }}
            >
              <div
                className="w-16 h-16 rounded-xl overflow-hidden flex-shrink-0"
                style={{ border: "1.5px solid #E0D0B0" }}
              >
                <img
                  src={product.image?.[0]}
                  alt={product.name}
              ...
              <div className="flex-1 min-w-0">
                <p className="text-xs font-medium" style={{ color: "#9A8060" }}>
                  Current image
                </p>
                <p
                  ...
                  style={{ color: "#B0A080" }}
                >
                  Image updates not supported via this form
                </p>
              </div>
              <div
                className="w-8 h-8 rounded-xl flex items-center justify-center"
                style={{ background: "#EDE4CE", color: "#B0A080" }}
              >
                <ImagePlus size={14} />
              </div>
            </div>
            ...
            {form.price &&
              form.offerPrice &&
              Number(form.price) > Number(form.offerPrice) && (
                <div
                ...
                >
                  ...
                  {Math.round(
                    ((form.price - form.offerPrice) / form.price) * 100,
                  )}
                  % discount applied
                </div>
              )}
            ...
            <div className="flex gap-3 pt-1">
              <button
                ...
                onMouseEnter={(e) =>
                  (e.currentTarget.style.background = "#E0D0B0")
                }
                onMouseLeave={(e) =>
                  (e.currentTarget.style.background = "#EDE4CE")
                }
              >
                Cancel
              </button>
              <button
                ...
                style={{
                  background: saving ? "#B07060" : "#8B3A2A",
                  color: "#FAF0DC",
                  opacity: saving ? 0.8 : 1,
                }}
                onMouseEnter={(e) => {
                  if (!saving) e.currentTarget.style.background = "#7A2E1E";
                }}
                onMouseLeave={(e) => {
                  if (!saving) e.currentTarget.style.background = "#8B3A2A";
                }}
              >
                {saving ? (
                  <>
...
const ProductList = () => {
  ...
  useEffect(() => {
    axios.get("/product/list").then(({ data }) => {
  ...
  return (
    ...
    >
      ...
      <div className="mb-6 flex flex-col sm:flex-row sm:items-end justify-between gap-3">
        ...
        <div
          className="flex items-center gap-2 px-3 py-1.5 rounded-full text-sm font-semibold self-start sm:self-auto"
          style={{
            background: "#EDE4CE",
            color: "#6B5140",
      ...
      <div
        ...
        style={{
          ...
          boxShadow: "0 2px 0 #C8920A18, 0 4px 16px #1E100808",
        }}
      >
        ...
        <div className="flex gap-3 flex-wrap">
          {[
            {
              icon: <Filter size={13} strokeWidth={1.8} />,
      ...
      {filtered.length === 0 && (
        ...
        >
          ...
          <p className="text-sm font-medium" style={{ color: "#9A8060" }}>
            No products found
          </p>
        </div>
      )}
      ...
      {filtered.length > 0 && (
        <div
          className="hidden md:block rounded-3xl overflow-hidden mb-5"
          style={{
            background: "#FEFAF2",
            border: "1px solid #E0D2B4",
        ...
        >
          <div
            className="grid items-center px-5 py-3 text-xs font-semibold uppercase"
            style={{
              gridTemplateColumns: "2.5fr 1fr 1fr 1fr 1.2fr 1fr",
              color: "#9A8060",
              letterSpacing: "0.08em",
              borderBottom: "1px solid #E0D2B4",
              background: "#F5EDD8",
            }}
          >
            <span>Product</span>
            ...
            return (
              <div
                ...
                style={{
                  gridTemplateColumns: "2.5fr 1fr 1fr 1fr 1.2fr 1fr",
                  borderBottom:
                    i < filtered.length - 1 ? "1px solid #EDE4CE" : "none",
                }}
                onMouseEnter={(e) =>
              ...
              >
                ...
                {/* MRP */}
                <div
                  className={`flex items-center gap-0.5 text-sm ${product.offerPrice ? "line-through" : ""}`}
                ...
                <div>
                  <div
                    ...
                    style={{
                      color: product.offerPrice ? "#1E1008" : "#9A8060",
                    }}
                  >
                    <IndianRupee size={13} strokeWidth={2} />
                ...
                <button
                  ...
                  style={{
                    ...
                    color: product.inStock ? "#6A8B3A" : "#8B3A2A",
                    cursor: "pointer",
                  }}
                  onMouseEnter={(e) =>
                ...
                >
                  {product.inStock ? (
                    <>
                      <ToggleRight size={16} strokeWidth={2} /> In Stock
                    </>
                  ) : (
                    <>
                      <ToggleLeft size={16} strokeWidth={2} /> Out of Stock
                    </>
                  )}
                </button>
                ...
                <div className="flex items-center justify-center gap-2">
                  <button
                    ...
                    onMouseEnter={(e) => {
                      e.currentTarget.style.background = "#4A7CC725";
                      e.currentTarget.style.transform = "scale(1.05)";
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.background = "#4A7CC712";
                  ...
                  <button
                    ...
                    onMouseEnter={(e) => {
                      e.currentTarget.style.background = "#8B3A2A25";
                      e.currentTarget.style.transform = "scale(1.05)";
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.background = "#8B3A2A12";
                      e.currentTarget.style.transform = "scale(1)";
                    }}
                  >
            ...
            return (
              ...
              >
                <div className="flex gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-3 mt-2">
                      ...
                      <div
                        className="flex items-center gap-0.5 text-xs line-through"
                        style={{ color: "#9A8060" }}
                      >
                ...
                >
                  {product.inStock ? (
                    <>
                      <ToggleRight size={17} strokeWidth={2} /> In Stock
                    </>
                  ) : (
                    <>
                      <ToggleLeft size={17} strokeWidth={2} /> Out of Stock
                    </>
                  )}
                </button>
              </div>
